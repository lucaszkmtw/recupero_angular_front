angular.module('app.crm.contacts', ['app.core', 'app.crm', 'app.system', 'app.system.persons'])
    .config(['$stateProvider', $stateProvider => {
        $stateProvider
            .state('app.crm.contacts', {
                url: '/contacts',
                controller: 'CrmContactsController',
                resolve: loadSequence('jqueryui', 'angularFileUpload', 'toastr'),
                templateUrl: 'app/crm/contacts/index.html',
                ncyBreadcrumb: {
                    skip: true
                }
            })
            .state('app.crm.contacts.group', {
                url: '/group/{groupId}',
                controller: 'CrmContactsListController',
                resolve: loadSequence('jqueryui', 'jqGrid'),
                ncyBreadcrumb: {
                    parent: 'app.crm.contacts',
                    label: 'crm.contacts'
                },
                templateUrl: 'app/crm/contacts/list.html'
            })
            .state('app.crm.newcontact', {
                url: '/contacts/new',
            ...
            .state('app.crm.contact', {
                url: '/contact/{contactId}',
                controller: 'CrmContactViewController',
            ...
            .state('app.crm.contact.info', {
                url: '/info',
                templateUrl: 'app/crm/contacts/view.info.html',
                ncyBreadcrumb: {
                    parent: 'app.crm.contacts.group',
                    label: 'crm.contacts'
                }
            })
            .state('app.crm.contact.emptytab', {
                url: '/emptytab',
            ...
            .state('app.crm.contact.health', {
                url: '/health',
                controller: 'CrmContactHealthController',
            ...
            .state('app.crm.contact.crm', {
                url: '/crm',
                controller: 'CrmContactCrmController',
            ...
            .state('app.crm.contact.Préstamos', {
                url: '/Prestamos',
                controller: 'CrmContactLoanController',
            ...
            .state('app.crm.contact.Cobranzas', {
                url: '/Cobranzas',
                templateUrl: 'app/crm/contacts/view.emptytab.html',
                ncyBreadcrumb: {
                    parent: 'app.crm.contacts.group',
            ...
            .state('app.crm.contact.procurement', {
                url: '/procurement',
            ...
            .state('app.crm.contact.financials', {
                url: '/financials',
                templateUrl: 'app/crm/contacts/view.emptytab.html',
                ncyBreadcrumb: {
                    parent: 'app.crm.contacts.group',
            ...
            .state('app.crm.contact.polls', {
                url: '/polls',
                controller: 'CrmContactPollsController',
            ...
            .state('app.crm.contact.projects', {
                url: '/projects',
                templateUrl: 'app/crm/contacts/view.emptytab.html',
                ncyBreadcrumb: {
                    parent: 'app.crm.contacts.group',
            ...
            .state('app.crm.contact.Contenidos', {
                url: '/Contenidos',
                templateUrl: 'app/crm/contacts/view.emptytab.html',
                ncyBreadcrumb: {
                    parent: 'app.crm.contacts.group',
            ...
            .state('app.crm.contact.health.documents', {
                url: '/documents',
            ...
            .state('app.crm.contact.businesspartner', {
                url: '/businesspartner',
                controller: 'CrmContactBusinessPartnerController',
    ...
    .controller('CrmContactsController', ($scope, $translate, $state, Restangular, $log, dialogs, toastr, $timeout) => {
        ...
        $scope.showContacts = (group) => {
            ...
            $state.go('app.crm.contacts.group', params);
        }
        ...
        $scope.showImportDialog = () => {
            ...
            var modalInstance = dialogs.create('/app/crm/contacts/importmodal.html', 'CrmImportDialogCtrl', {}, 'lg');
            modalInstance.result.then(
                (result) => {
    ...
    .controller('CrmImportDialogCtrl', ($scope, $uibModalInstance, Restangular, $log, FileUploader) => {
    ...
    .controller('CrmContactViewController', ($scope, Restangular, $log, $translate, PersonService, $stateParams, $templateCache, $state, $rootScope) => {
        ...
        function load() {
            ...
            Restangular.all('crm').one('contact/' + contactId).get().then((result) => {
                ...
                if ($scope.contact.accountsCount != 0) {
                    $scope.tabData.push({
                        heading: 'Cuentas',
                        route: 'app.crm.contact.businesspartner'
                    });
                }
                ...
                for (var tab in $scope.tabData) {
                    if ($scope.tabData[tab].route == $state.current.name
                        || (
                            $scope.tabData[tab].route == 'app.crm.contact.health.clinicalhistory' &&
                            (
                                $state.current.name == 'app.crm.contact.health.clinicalhistory'
                                || $state.current.name == 'app.crm.contact.health.claims'
                                || $state.current.name == 'app.crm.contact.health.documents'
                            )
                        )
                    ) {
    ...
    .controller('CrmContactsListController', ($scope, $translate, $stateParams, $state, Restangular, $log) => {
        $scope.groupId = $stateParams.groupId;
    })
    .controller('CrmContactEditController', ($scope, $translate, $stateParams, $state, Restangular, $log, dialogs) => {
        ...
        $scope.save = () => {
            if (id) {
                $scope.contact.put().then(() => { $state.go('app.crm.contacts'); });
            } else {
                Restangular.service('crm/contact').post($scope.contact).then(() => { $state.go('app.crm.contacts'); });
            }
        }
    ...
    .controller('CrmBankAccountModalController', ($log, $scope, data, $uibModalInstance) => {
        $scope.save = () => {
            $uibModalInstance.close($scope.bankaccount);
        }
    })
    .controller('CrmContactHealthController', ($log, $scope, $stateParams, Restangular) => {
        var contactId = $stateParams.contactId;
    ...
    .controller('CrmContactHealthPatientClinicalhistoryController', ($log, $scope) => {
    ...
    .controller('CrmContactHealthPatientClaimsController', ($log, $scope) => {
    ...
    .controller('CrmContactHealthPatientDocumentsController', ($log, $scope, $window, Restangular) => {
        $scope.$on('$viewContentLoaded',
            (event) => {
                if ($scope.patient) {
                    getDocuments();
    ...
    .controller('CrmContactCrmController', ($log, $scope, $window) => {
        $scope.$on('$viewContentLoaded',
            (event) => {
                if ($scope.contact) {
    ...
    .controller('CrmContactLoanController', ($log, $scope, $window, Restangular) => {
        $scope.$on('$viewContentLoaded',
            (event) => {
                if ($scope.contact) {
                    $scope.$broadcast('loadData', $scope.contact.person.id);
    ...
    .controller('CrmContactPollsController', ($log, $scope, $window, Restangular) => {
        $scope.$on('$viewContentLoaded',
            (event) => {
                if ($scope.contact) {
                    $scope.$broadcast('loadData', $scope.contact.person.id);
    ...
    .controller('CrmContactBusinessPartnerController', ($log, $scope, $window) => {
    ...
    .controller('CrmStartCampaignDialogCtrl', ($log, $scope, Restangular, data, $uibModalInstance) => {
    ...
    .directive('crmContactsGrid', ($log, $compile, $state, $document, dialogs, Restangular, $http, $timeout, authManager) => {
        return {
            restrict: 'A',
            ...
            link(scope: any, element) {
                ...
                function menuFormatter(cellvalue: any, options: any, rowObject: any) {
                    return '<div class="btn-group zindex" uib-dropdown style="position: absolute">' +
                        '<a href uib-dropdown-toggle id="menu_' + rowObject.contactId + '"><i class="fa fa-ellipsis-v" ></i></a>' +
                        '<ul class="dropdown-menu pull-right zindex" uib-dropdown-menu role="menu" aria-labelledby="menu_' + rowObject.contactId + '" style="margin-right:10px; z-index:9999">' +
                        '<li role="menuitem" ><a href="#" ui-sref="app.crm.contact.info({ contactId: ' + rowObject.contactId + '})">Ver </a></li>' +
                        '<li role="menuitem" ><a href="#" ui-sref="app.crm.editcontact({ contactId: ' + rowObject.contactId + '})">Editar </a></li>' +
                        '<li role="menuitem" ><a href ng-click="$event.preventDefault(); abrirModalGrupos(' + rowObject.contactId + ')">Etiquetar </a></li>' +
                        '<li role="menuitem" ><a href ng-click="$event.preventDefault(); abrirModalGrupos(' + rowObject.contactId + ')">Enviar correo </a></li>' +
                        //'<li class="divider" ></li>' +
                        '<li role="menuitem" ><a href ng-click="$event.preventDefault(); eliminarContacto(' + rowObject.contactId + ')">Remover </a></li> ' +
                        '</ul></div> ';
                };
